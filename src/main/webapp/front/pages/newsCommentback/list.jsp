            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">新闻评论展示</span>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 newsCommentbackContent 字段去除无用字符 如果字段长度大于60  就截取到60
            newsCommentbackContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            // 当前表
                                        // 获取列表数据
            http.request('newsCommentback/list', 'get', param, function(res) {
...
// 当前表的字典表
       ...
       function commentbackTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=commentback_types", 'get', {}, function (res) {
               if(res.code == 0){
